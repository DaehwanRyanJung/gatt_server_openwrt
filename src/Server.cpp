...
Server::Server(const std::string &serviceName, const std::string &advertisingName, const std::string &advertisingShortName,
    ...
    : advertisingName(advertisingName), advertisingShortName(advertisingShortName), serviceName(serviceName)
{
    // Save our names
    ...
    registerServicePlugins(); // register customised GATT services and Characteristics.
